...
import { ToptraumaChartResponse } from '../toptrauma/toptrauma-chart-response';
import { TraumapercentageChartResponse } from '../traumapercentage/traumapercentage-chart-response';
...
export class ToptraumaTraumapercentageServiceService {
  ...
  getGender() {
    this.apiService
      .authenticatedGet<any>('/cans-backend-rws/Resources/Dashboard/gender')
      .subscribe((response) => {
        const gender: any[] = [];
  ...
  getRace() {
    this.apiService
      .authenticatedGet<any>('/cans-backend-rws/Resources/Dashboard/ethnicity')
      .subscribe((response) => {
        const race: any[] = [];
        response.forEach((x: any) =>
