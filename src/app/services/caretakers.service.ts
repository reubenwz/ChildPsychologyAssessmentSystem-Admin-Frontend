...
import { CreateCaretakerParams } from '../dashboard/client-management-module-dashboard/create-caretaker-dialog/create-caretaker-params';
  ...
  public toggleActiveStatus(caretakerId: Number): void {
    ...
    this.apiService
      .authenticatedPost<any>(
        '/cans-backend-rws/Resources/ClientManagement-AdminSystem/caretakers/' +
          caretakerId +
          '/updateActive'
      )
      .subscribe(
